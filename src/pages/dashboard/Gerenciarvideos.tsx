                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2 mt-2">
                    <div
                      className={`h-2 rounded-full ${
                        folder.percentage_used > 90 ? 'bg-red-600' :
            ...
            <div className="flex items-center space-x-3">
              ...
              {selectedFolderData?.server_info && (
                <span className={`text-xs px-2 py-1 rounded-full ${
                  selectedFolderData.server_info.exists ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                }`}>
                    ...
                    <tr key={video.id} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="py-3 px-4 text-center">
                        <div className="flex items-center justify-center space-x-1">
                          ...
                          <span className={`text-xs ${
                            video.is_mp4 && !video.bitrate_exceeds_limit ? 'text-green-600' : 'text-yellow-600'
                          }`}>
                ...
                {selectedFolderData.server_info && (
                  <div>
                    ...
                    <span className={`ml-2 font-medium ${
                      selectedFolderData.server_info.exists ? 'text-green-600' : 'text-red-600'
                    }`}>
